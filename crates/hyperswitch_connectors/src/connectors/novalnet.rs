    ...
    for Novalnet
{
    ...
    fn get_request_body(
        ...
        let connector_req = novalnet::NovalnetTokenRequest::try_from(req)?;
    ...
    {
        let response: novalnet::NovalnetTokenResponse = res
            .response
            .parse_struct("NovalnetTokenResponse")
...
impl webhooks::IncomingWebhook for Novalnet {
    ...
    fn get_webhook_source_verification_message(
        ...
        let notif = get_webhook_object_from_body(request.body)
            .change_context(errors::ConnectorError::WebhookSourceVerificationFailed)?;
        let (transaction_amount, transaction_currency) = match notif.transaction {
        ...
        let amount = transaction_amount
            ...
            .unwrap_or("".to_string());
        let currency = transaction_currency
            .map(|amount| amount.to_string())
            .unwrap_or("".to_string());
